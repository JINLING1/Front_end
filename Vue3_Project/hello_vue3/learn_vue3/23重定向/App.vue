<template>
  <div class = "app">
    ...
    <!-- 导航区 -->
     <div class = "navigate">
      <!-- RouterLink是一个组件，active-class被激活时的类名 -->
       <!-- to的第一种写法，字符串写法 -->
        <!-- 控制路由跳转时操作浏览器历史记录的模式：push/replace -->
      <RouterLink replace to="/home" active-class="active">首页</RouterLink>
      <!-- to的第二种写法 对象写法(1.名字跳转  2.路径跳转) -->
...
<script lang=ts setup name = "App">//设置语言用ts
